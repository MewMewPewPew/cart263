class Flower {
    constructor(x,y,size,stemLength,petalColor) {
        ...
        let self = this; // so "this" refers to the object (method) instead of the div element(function)
    ...
    // constructor() { // used for part 1- end
    //     // We write instructions to set up a Flower here
    //     // Position and size information
    ...
    this.flowerStemDiv.style.left = (this.x + 8) +"px"; // for sum reason it was more to the left when i made the flower smaller
